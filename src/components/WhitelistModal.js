...
export function WhitelistModal(props) {
  let { hide, ID, success, projectName, accessRules, units, toggleModal } =
    props;
  let cnt = 0;
                ...
                {ID === null ? (
                  <div>
                    <Form.Control
                      ...
                      isInvalid={
                        !plates.includes(state.plateNumber) && validated
                      }
                    />
              ...
              <Col sm={6}>
                ...
                >
                  ...
                  {accessRules.map((rule) => (
                    <option value={rule.accessRuleID}>
                      {rule.accessRuleName}
                    </option>
                  ))}
                </Form.Control>
