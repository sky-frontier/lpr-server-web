...
export function GateModal(props) {
  let { hide, gateID, toggleModal, success, newState, projectID, gateTypes } =
    props;
  ...
  useEffect(() => {
    ...
    getWhitelistTags()
      .then(async (data) => {
        setWhiteListTags(
          data.message.whitelistTags.map((tag) => ({
            label: tag,
            value: tag,
          }))
        );
        ...
        >
          <div>
            ...
            <Form.Group as={Row}>
              ...
              <Form.Label column sm={6} className="align-items-center d-flex">
                <TimeField
            ...
            <Form.Group as={Row}>
              ...
              <Form.Label column className="align-items-center d-flex" sm={6}>
                <TimeField
