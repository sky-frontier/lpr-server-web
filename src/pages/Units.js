...
import { PencilSquare, Trash, ClipboardX } from "react-bootstrap-icons";
          ...
          <Table aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="center">
                  <b>Maximum Vehicles</b>
                </TableCell>
                <TableCell align="center">
                  <b>Current Vehicles</b>
                </TableCell>
                ...
                (rowsPerPage > 0
                  ...
                  <TableRow key={row.unitID}>
                    ...
                    <TableCell align="center">
                      {row.entryGates === null
                        ? null
                        : row.entryGates.map((gate) => (
                            <div>
                              {gate === null ? null : gateNames[gate]} <br />
                            </div>
                          ))}
                    </TableCell>
                    <TableCell align="center">
                    ...
                    <TableCell align="center">
                      {!Array.isArray(row.currentPlates)
                        ? null
                        : row.currentPlates.map((plateNumber) => (
                            <div>
                              {plateNumber} <br />
                            </div>
                          ))}
